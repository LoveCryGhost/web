@extends(config('theme.staff.staff-app-login'))
    ...
    <body class="hold-transition theme-yellow bg-img" data-overlay="3">
        <div class="auth-2-outer row align-items-center h-p100 m-0">
            <div class="auth-2 badge-success">
                ...
                <!-- /.login-logo -->
                <div class="auth-body">
                    <p class="auth-msg text-black-50">Staff 登入</p>

                    <form action="{{route('staff.login.submit')}}" method="post" class="form-element">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="checkbox">
                                    <input type="checkbox"  name="restaff" id="restaff" {{ old('restaff') ? 'checked' : '' }}>
                                    <label for="restaff" class="text-dark">記住我</label>
                                </div>
                            </div>
                            <!-- /.col -->
                            <div class="col-6">
                                <div class="fog-pwd">
                                    <a href="{{route('staff.password.request')}}"><i class="ion ion-locked"></i> 忘記密碼 ?</a><br>
                                </div>
                            </div>
                            <!-- /.col -->
